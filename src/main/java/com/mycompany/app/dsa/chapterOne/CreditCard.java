...
public class CreditCard {
    ...
    public boolean charge(double price){ //make a charge
        if(price + balance > limit) //if charge would surpass limit
            ...
            //at this point the charge is successfull
    ...
    public static void main(String[] args) {
        ...
        wallet[1] = new CreditCard("John Bowman", "California Savings", "3485 0399 3395 1954", 3500);
        wallet[2] = new CreditCard("John Bowman", "California Savings", "5391 0375 9387 5309", 2500,300);
